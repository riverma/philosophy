# Agent guide — Philosophy Cards

A dependency-free static PWA served at `philosophy.riverma.com` via GitHub Pages (deploy from the default branch, root). Files live at the repo root; keep all asset paths relative.
